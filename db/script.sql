...
BEGIN
	...
	IF(X = 0) THEN
		INSERT INTO USERS values (RUT,NAME,LASTNAME,USERNAME,MAIL,TYPE,1,CAREER,PHONE,ADDRESS,PASS);
		RETURN 1;
	ELSE
		RETURN 2;
	END IF;
...
WHERE  ADDDATE(MOVEMENT_HEADER.DATE_BEGIN, INTERVAL MOVEMENT_HEADER.DAYS DAY) < SYSDATE() AND MOVEMENT_HEADER.STATUS = 0

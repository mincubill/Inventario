...
insert into MOVEMENT_BODY(ID, PRODUCT_M, HEADER, CANT) VALUES( 1, 1, 1, 10)
insert into MOVEMENT_BODY(ID, PRODUCT_M, HEADER, CANT) VALUES( 2, 2, 1, 5)
insert into MOVEMENT_BODY(ID, PRODUCT_M, HEADER, CANT) VALUES( 3, 1, 2, 2)
insert into MOVEMENT_BODY(ID, PRODUCT_M, HEADER, CANT) VALUES( 4, 1, 3, 1)